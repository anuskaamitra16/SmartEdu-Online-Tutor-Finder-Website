...
// Check if 'sid' is provided in the URL
if(isset($_GET['eid'])) {
    $sid = $_GET['eid'];
...
<?php include("admin_inc/top.php"); ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Students</h1>
                    <form action="updst.php" method="post">
                    <p><input type="hidden" name="id" value="<?php echo $row['sid'];?>"></p>
                    <p>Name</p>
                    ...
                    <p><input type="submit" name="editst" value="Save"></p>
                    </form>
                    </div>
                <!-- /.container-fluid -->
