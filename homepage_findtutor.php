...
<?php include("inc/home_tutor_nav.html"); ?>
		<!-- End header -->
        <form action="homepage_findtutor.php" method="GET" class="search-form search-container">
    ...
    <div class="container1">
        ...
        $num_reviews = $ratings_row['num_reviews'];
                ...
                <div class="card mb-3">
                    ...
                    <p class="card-text"><strong>Ratings:</strong> <a href="home_ratings_reviews.php?teacher_id=<?php echo $teacher_id; ?>"><?php echo number_format($avg_rating, 1); ?>⭐</a> (<?php echo $num_reviews; ?> reviews)</p>
                    ...
                    <p class="card-text"><strong>Gender:</strong> <?php echo $row['gender']; ?></p>
                        ...
                        <button type="submit" name="apply" class="applyButton">Request</button>
...
applyButtons.forEach(function(button) {
    button.addEventListener("click", function() {
        alert("You have to log in to request the tutors");
    });
});
</script>
